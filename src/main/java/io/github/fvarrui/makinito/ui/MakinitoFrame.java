...
import io.github.fvarrui.makinito.hardware.events.MakinitoAdapter;
import io.github.fvarrui.makinito.i18n.Messages;
import io.github.fvarrui.makinito.software.parser.ParserException;
import io.github.fvarrui.makinito.ui.panels.BusPanel;
import io.github.fvarrui.makinito.ui.panels.CPUPanel;
import io.github.fvarrui.makinito.ui.panels.MemoryPanel;
...
//	private static final String LAF_NIMBUS = "com.sun.java.swing.plaf.nimbus.NimbusLookAndFeel";
	...
	private void initMenuBar() {
		...
		openMenuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_A, InputEvent.CTRL_DOWN_MASK));
	...
	protected void onFrecuenciaSpinnerStateChanged(ChangeEvent e) {
		makinito.getClock().setFrequency((Integer)frequencySpinner.getValue());
	...
	private void update() {
		...
		// actualiza unidad aritm�tico-l�gica
